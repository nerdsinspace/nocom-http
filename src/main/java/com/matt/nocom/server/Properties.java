...
public interface Properties {
  ...
  int DISTANCE            = Integer.parseInt(System.getProperty("nocom.distance", "1000"));
  int VIEW_DISTANCE       = Integer.parseInt(System.getProperty("nocom.distance.view", String.valueOf(9 * 16)));
