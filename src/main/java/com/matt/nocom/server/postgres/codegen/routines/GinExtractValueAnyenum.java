...
public class GinExtractValueAnyenum extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1007877590;
     ...
     */
    public GinExtractValueAnyenum() {
        super("gin_extract_value_anyenum", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
