...
public class GbtInetConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1290423604;

    /**
     * The parameter <code>gbt_inet_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInetConsistent() {
        super("gbt_inet_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
