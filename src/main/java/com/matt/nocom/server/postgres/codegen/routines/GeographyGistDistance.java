...
public class GeographyGistDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1098751195;

    /**
     * The parameter <code>geography_gist_distance.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>geography_gist_distance._3</code>.
     */
     ...
     */
    public GeographyGistDistance() {
        super("geography_gist_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
