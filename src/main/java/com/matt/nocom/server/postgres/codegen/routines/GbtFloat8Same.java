...
public class GbtFloat8Same extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1755069911;
    ...
    public GbtFloat8Same() {
        super("gbt_float8_same", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
