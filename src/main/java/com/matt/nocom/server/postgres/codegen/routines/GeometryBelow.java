...
public class GeometryBelow extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1799969853;

    /**
     * The parameter <code>geometry_below.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryBelow() {
        super("geometry_below", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
