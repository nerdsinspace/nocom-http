...
public class GeometryHash extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1987330793;

    /**
     * The parameter <code>geometry_hash.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryHash() {
        super("geometry_hash", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
