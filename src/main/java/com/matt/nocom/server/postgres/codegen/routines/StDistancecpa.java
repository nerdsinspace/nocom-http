...
public class StDistancecpa extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1751037070;

    /**
     * The parameter <code>st_distancecpa.RETURN_VALUE</code>.
     */
    ...
    public StDistancecpa() {
        super("st_distancecpa", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
