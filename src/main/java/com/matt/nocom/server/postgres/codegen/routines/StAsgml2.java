...
public class StAsgml2 extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -2098633332;
    ...
    /**
     * The parameter <code>st_asgml.version</code>.
     */
    public static final Parameter<Integer> VERSION = Internal.createParameter("version", org.jooq.impl.SQLDataType.INTEGER, false, false);
     ...
     */
    public static final Parameter<String> NPREFIX = Internal.createParameter("nprefix", org.jooq.impl.SQLDataType.CLOB.defaultValue(org.jooq.impl.DSL.field("NULL::text", org.jooq.impl.SQLDataType.CLOB)), true, false);

    /**
     * The parameter <code>st_asgml.id</code>.
     */
    public static final Parameter<String> ID = Internal.createParameter("id", org.jooq.impl.SQLDataType.CLOB.defaultValue(org.jooq.impl.DSL.field("NULL::text", org.jooq.impl.SQLDataType.CLOB)), true, false);
