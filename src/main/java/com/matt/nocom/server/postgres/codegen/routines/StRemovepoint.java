...
public class StRemovepoint extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1865414104;
    ...
    /**
     * The parameter <code>st_removepoint._2</code>.
     */
     ...
     */
    public StRemovepoint() {
        super("st_removepoint", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
