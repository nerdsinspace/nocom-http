...
public class GinExtractValueTimestamptz extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 525502545;
    ...
    /**
     * The parameter <code>gin_extract_value_timestamptz._1</code>.
     */
     ...
     */
    public GinExtractValueTimestamptz() {
        super("gin_extract_value_timestamptz", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
