...
public class StNumpoints extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = 1825703808;

    /**
     * The parameter <code>st_numpoints.RETURN_VALUE</code>.
     */
     ...
     */
    public StNumpoints() {
        super("st_numpoints", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
