...
public class GbtInt8Distance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1044994521;

    /**
     * The parameter <code>gbt_int8_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInt8Distance() {
        super("gbt_int8_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
