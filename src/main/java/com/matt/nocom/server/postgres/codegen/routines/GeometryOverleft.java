...
public class GeometryOverleft extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 1576477484;

    /**
     * The parameter <code>geometry_overleft.RETURN_VALUE</code>.
     */
    ...
    public GeometryOverleft() {
        super("geometry_overleft", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
