...
public class GbtInetPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1325596447;
     ...
     */
    public GbtInetPenalty() {
        super("gbt_inet_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
