...
public class GbtByteaPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1725955265;
     ...
     */
    public GbtByteaPicksplit() {
        super("gbt_bytea_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
