...
public class GeographyGistPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1092193288;
    ...
    public GeographyGistPenalty() {
        super("geography_gist_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
