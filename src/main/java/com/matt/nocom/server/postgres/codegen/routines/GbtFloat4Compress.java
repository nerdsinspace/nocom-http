...
public class GbtFloat4Compress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1548393105;
     ...
     */
    public GbtFloat4Compress() {
        super("gbt_float4_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
