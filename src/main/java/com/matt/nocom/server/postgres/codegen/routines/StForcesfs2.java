...
public class StForcesfs2 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1173620188;
    ...
    /**
     * The parameter <code>st_forcesfs.version</code>.
     */
     ...
     */
    public StForcesfs2() {
        super("st_forcesfs", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
