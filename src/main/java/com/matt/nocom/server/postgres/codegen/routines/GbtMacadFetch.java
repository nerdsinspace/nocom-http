...
public class GbtMacadFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1897602678;
     ...
     */
    public GbtMacadFetch() {
        super("gbt_macad_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
