...
public class GbtFloat4Penalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -882702876;
     ...
     */
    public GbtFloat4Penalty() {
        super("gbt_float4_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
