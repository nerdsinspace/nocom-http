...
public class GbtEnumPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -697678100;
     ...
     */
    public GbtEnumPenalty() {
        super("gbt_enum_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
