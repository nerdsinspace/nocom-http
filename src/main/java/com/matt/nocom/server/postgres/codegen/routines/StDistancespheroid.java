...
public class StDistancespheroid extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 1349962364;

    /**
     * The parameter <code>st_distancespheroid.RETURN_VALUE</code>.
     */
    ...
    public StDistancespheroid() {
        super("st_distancespheroid", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
