...
public class GbtNumericPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2003966588;
     ...
     */
    public GbtNumericPicksplit() {
        super("gbt_numeric_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
