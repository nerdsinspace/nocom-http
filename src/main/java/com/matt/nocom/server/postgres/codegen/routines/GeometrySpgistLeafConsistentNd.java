...
public class GeometrySpgistLeafConsistentNd extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -923592075;

    /**
     * The parameter <code>geometry_spgist_leaf_consistent_nd.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometrySpgistLeafConsistentNd() {
        super("geometry_spgist_leaf_consistent_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
