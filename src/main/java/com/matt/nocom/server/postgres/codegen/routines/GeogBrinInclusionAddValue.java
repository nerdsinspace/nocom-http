...
public class GeogBrinInclusionAddValue extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1228637694;

    /**
     * The parameter <code>geog_brin_inclusion_add_value.RETURN_VALUE</code>.
     */
     ...
     */
    public GeogBrinInclusionAddValue() {
        super("geog_brin_inclusion_add_value", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
