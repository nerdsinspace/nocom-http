...
public class GinExtractQueryMoney extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1445999948;
    ...
    /**
     * The parameter <code>gin_extract_query_money._3</code>.
     */
     ...
     */
    public GinExtractQueryMoney() {
        super("gin_extract_query_money", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
