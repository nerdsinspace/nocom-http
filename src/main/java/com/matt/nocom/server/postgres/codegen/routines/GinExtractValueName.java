...
public class GinExtractValueName extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -916028499;
    ...
    /**
     * The parameter <code>gin_extract_value_name._1</code>.
     */
     ...
     */
    public GinExtractValueName() {
        super("gin_extract_value_name", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
