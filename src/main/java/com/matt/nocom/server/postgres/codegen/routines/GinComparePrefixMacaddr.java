...
public class GinComparePrefixMacaddr extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 359310448;

    /**
     * The parameter <code>gin_compare_prefix_macaddr.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_macaddr._3</code>.
     */
     ...
     */
    public GinComparePrefixMacaddr() {
        super("gin_compare_prefix_macaddr", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
