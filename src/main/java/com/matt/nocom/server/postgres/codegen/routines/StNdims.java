...
public class StNdims extends AbstractRoutine<Short> {

    private static final long serialVersionUID = 835097858;

    /**
     * The parameter <code>st_ndims.RETURN_VALUE</code>.
     */
     ...
     */
    public StNdims() {
        super("st_ndims", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.SMALLINT);
