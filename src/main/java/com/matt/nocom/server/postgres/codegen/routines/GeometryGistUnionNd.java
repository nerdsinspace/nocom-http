...
public class GeometryGistUnionNd extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1757237165;
    ...
    /**
     * The parameter <code>geometry_gist_union_nd._1</code>.
     */
     ...
     */
    public GeometryGistUnionNd() {
        super("geometry_gist_union_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
