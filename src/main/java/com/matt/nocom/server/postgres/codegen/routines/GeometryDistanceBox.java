...
public class GeometryDistanceBox extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -986227224;

    /**
     * The parameter <code>geometry_distance_box.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryDistanceBox() {
        super("geometry_distance_box", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
