...
public class GeometrySpgistConfigNd extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -170761137;
     ...
     */
    public GeometrySpgistConfigNd() {
        super("geometry_spgist_config_nd", DefaultSchema.DEFAULT_SCHEMA);
