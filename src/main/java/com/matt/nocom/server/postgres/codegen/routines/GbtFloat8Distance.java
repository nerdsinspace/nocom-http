...
public class GbtFloat8Distance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1581126158;

    /**
     * The parameter <code>gbt_float8_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtFloat8Distance() {
        super("gbt_float8_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
