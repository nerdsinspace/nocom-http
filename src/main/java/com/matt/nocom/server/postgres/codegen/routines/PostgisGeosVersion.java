...
public class PostgisGeosVersion extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 1288247782;

    /**
     * The parameter <code>postgis_geos_version.RETURN_VALUE</code>.
     */
    ...
    public PostgisGeosVersion() {
        super("postgis_geos_version", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
