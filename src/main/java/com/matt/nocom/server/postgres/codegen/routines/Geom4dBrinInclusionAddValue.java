...
public class Geom4dBrinInclusionAddValue extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1396800898;

    /**
     * The parameter <code>geom4d_brin_inclusion_add_value.RETURN_VALUE</code>.
     */
     ...
     */
    public Geom4dBrinInclusionAddValue() {
        super("geom4d_brin_inclusion_add_value", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
