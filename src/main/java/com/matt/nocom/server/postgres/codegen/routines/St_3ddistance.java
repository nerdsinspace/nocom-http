...
public class St_3ddistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1955865827;

    /**
     * The parameter <code>st_3ddistance.RETURN_VALUE</code>.
     */
    ...
    public St_3ddistance() {
        super("st_3ddistance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
