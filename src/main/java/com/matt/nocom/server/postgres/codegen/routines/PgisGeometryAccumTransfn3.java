...
public class PgisGeometryAccumTransfn3 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1465338583;
    ...
    public PgisGeometryAccumTransfn3() {
        super("pgis_geometry_accum_transfn", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
