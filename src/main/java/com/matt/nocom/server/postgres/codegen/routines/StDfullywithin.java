...
public class StDfullywithin extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2048219607;

    /**
     * The parameter <code>st_dfullywithin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>st_dfullywithin._3</code>.
     */
     ...
     */
    public StDfullywithin() {
        super("st_dfullywithin", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
