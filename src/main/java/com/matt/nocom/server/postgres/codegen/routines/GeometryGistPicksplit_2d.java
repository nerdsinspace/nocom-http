...
public class GeometryGistPicksplit_2d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 382613109;
     ...
     */
    public GeometryGistPicksplit_2d() {
        super("geometry_gist_picksplit_2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
