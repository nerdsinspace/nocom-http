...
public class Geom2dBrinInclusionAddValue extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2040140797;

    /**
     * The parameter <code>geom2d_brin_inclusion_add_value.RETURN_VALUE</code>.
     */
     ...
     */
    public Geom2dBrinInclusionAddValue() {
        super("geom2d_brin_inclusion_add_value", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
