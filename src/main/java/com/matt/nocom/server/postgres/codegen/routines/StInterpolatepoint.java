...
public class StInterpolatepoint extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 1509949202;

    /**
     * The parameter <code>st_interpolatepoint.RETURN_VALUE</code>.
     */
    ...
    public StInterpolatepoint() {
        super("st_interpolatepoint", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
