...
public class GeographySpgistCompressNd extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2081640279;
     ...
     */
    public GeographySpgistCompressNd() {
        super("geography_spgist_compress_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
