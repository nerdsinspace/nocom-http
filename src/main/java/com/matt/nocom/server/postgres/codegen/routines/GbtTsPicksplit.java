...
public class GbtTsPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1722000179;
     ...
     */
    public GbtTsPicksplit() {
        super("gbt_ts_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
