...
public class _StWithin extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1037348711;

    /**
     * The parameter <code>_st_within.RETURN_VALUE</code>.
     */
     ...
     */
    public _StWithin() {
        super("_st_within", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
