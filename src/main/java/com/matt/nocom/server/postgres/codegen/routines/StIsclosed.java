...
public class StIsclosed extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1409675669;

    /**
     * The parameter <code>st_isclosed.RETURN_VALUE</code>.
     */
     ...
     */
    public StIsclosed() {
        super("st_isclosed", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
