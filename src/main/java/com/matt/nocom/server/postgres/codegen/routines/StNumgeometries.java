...
public class StNumgeometries extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1150118981;

    /**
     * The parameter <code>st_numgeometries.RETURN_VALUE</code>.
     */
     ...
     */
    public StNumgeometries() {
        super("st_numgeometries", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
