...
public class _StOverlaps extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1616790037;

    /**
     * The parameter <code>_st_overlaps.RETURN_VALUE</code>.
     */
     ...
     */
    public _StOverlaps() {
        super("_st_overlaps", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
