...
public class StOverlaps extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 518216683;

    /**
     * The parameter <code>st_overlaps.RETURN_VALUE</code>.
     */
     ...
     */
    public StOverlaps() {
        super("st_overlaps", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
