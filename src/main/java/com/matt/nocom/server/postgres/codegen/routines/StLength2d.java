...
public class StLength2d extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1474277181;

    /**
     * The parameter <code>st_length2d.RETURN_VALUE</code>.
     */
     ...
     */
    public StLength2d() {
        super("st_length2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
