...
public class GinComparePrefixVarbit extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1669982679;

    /**
     * The parameter <code>gin_compare_prefix_varbit.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixVarbit() {
        super("gin_compare_prefix_varbit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
