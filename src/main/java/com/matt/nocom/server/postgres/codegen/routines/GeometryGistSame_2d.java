...
public class GeometryGistSame_2d extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1886273555;
    ...
    public GeometryGistSame_2d() {
        super("geometry_gist_same_2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
