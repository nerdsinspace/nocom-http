...
public class GeometrySpgistChooseNd extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1014398543;
     ...
     */
    public GeometrySpgistChooseNd() {
        super("geometry_spgist_choose_nd", DefaultSchema.DEFAULT_SCHEMA);
