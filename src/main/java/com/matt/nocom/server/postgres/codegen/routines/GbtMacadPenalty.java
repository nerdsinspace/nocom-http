...
public class GbtMacadPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1311384008;
     ...
     */
    public GbtMacadPenalty() {
        super("gbt_macad_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
