...
public class StRelate3 extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -1883364399;
    ...
    /**
     * The parameter <code>st_relate._3</code>.
     */
     ...
     */
    public StRelate3() {
        super("st_relate", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
