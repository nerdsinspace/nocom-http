...
public class StAshexewkb2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1768146662;

    /**
     * The parameter <code>st_ashexewkb.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>st_ashexewkb._2</code>.
     */
     ...
     */
    public StAshexewkb2() {
        super("st_ashexewkb", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
