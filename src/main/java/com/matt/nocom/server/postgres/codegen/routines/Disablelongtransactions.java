...
public class Disablelongtransactions extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1346613124;

    /**
     * The parameter <code>disablelongtransactions.RETURN_VALUE</code>.
     */
    ...
    public Disablelongtransactions() {
        super("disablelongtransactions", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
