...
public class GbtFloat8Consistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1673194875;

    /**
     * The parameter <code>gbt_float8_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtFloat8Consistent() {
        super("gbt_float8_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
