...
public class GinComparePrefixMoney extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1582826064;

    /**
     * The parameter <code>gin_compare_prefix_money.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_money._3</code>.
     */
     ...
     */
    public GinComparePrefixMoney() {
        super("gin_compare_prefix_money", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
