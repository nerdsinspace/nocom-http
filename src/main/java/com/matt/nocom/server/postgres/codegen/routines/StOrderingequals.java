...
public class StOrderingequals extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 1157948016;

    /**
     * The parameter <code>st_orderingequals.RETURN_VALUE</code>.
     */
    ...
    public StOrderingequals() {
        super("st_orderingequals", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
