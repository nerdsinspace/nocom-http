...
public class StTouches extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -194045000;

    /**
     * The parameter <code>st_touches.RETURN_VALUE</code>.
     */
     ...
     */
    public StTouches() {
        super("st_touches", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
