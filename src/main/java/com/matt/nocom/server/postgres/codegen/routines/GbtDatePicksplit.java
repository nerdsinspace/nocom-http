...
public class GbtDatePicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1170762276;
     ...
     */
    public GbtDatePicksplit() {
        super("gbt_date_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
