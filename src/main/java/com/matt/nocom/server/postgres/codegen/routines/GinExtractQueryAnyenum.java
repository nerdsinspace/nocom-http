...
public class GinExtractQueryAnyenum extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1471940223;
    ...
    /**
     * The parameter <code>gin_extract_query_anyenum._3</code>.
     */
     ...
     */
    public GinExtractQueryAnyenum() {
        super("gin_extract_query_anyenum", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
