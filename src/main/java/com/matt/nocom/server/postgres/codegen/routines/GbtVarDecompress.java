...
public class GbtVarDecompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1570941828;
     ...
     */
    public GbtVarDecompress() {
        super("gbt_var_decompress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
