...
public class GeographySpgistConfigNd extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -772414654;
     ...
     */
    public GeographySpgistConfigNd() {
        super("geography_spgist_config_nd", DefaultSchema.DEFAULT_SCHEMA);
