...
public class GbtIntvPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -560836235;
     ...
     */
    public GbtIntvPicksplit() {
        super("gbt_intv_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
