...
public class GeometrySameNd extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1048899226;

    /**
     * The parameter <code>geometry_same_nd.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometrySameNd() {
        super("geometry_same_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
