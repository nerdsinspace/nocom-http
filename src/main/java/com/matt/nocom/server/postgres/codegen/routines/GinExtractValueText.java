...
public class GinExtractValueText extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -500720992;
    ...
    /**
     * The parameter <code>gin_extract_value_text._1</code>.
     */
     ...
     */
    public GinExtractValueText() {
        super("gin_extract_value_text", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
