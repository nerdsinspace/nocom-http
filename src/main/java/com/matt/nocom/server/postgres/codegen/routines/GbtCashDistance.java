...
public class GbtCashDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1144954680;

    /**
     * The parameter <code>gbt_cash_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtCashDistance() {
        super("gbt_cash_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
