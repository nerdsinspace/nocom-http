...
public class _StLongestline extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1485862814;
     ...
     */
    public _StLongestline() {
        super("_st_longestline", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
