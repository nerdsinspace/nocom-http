...
public class GbtIntvFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1184524131;
     ...
     */
    public GbtIntvFetch() {
        super("gbt_intv_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
