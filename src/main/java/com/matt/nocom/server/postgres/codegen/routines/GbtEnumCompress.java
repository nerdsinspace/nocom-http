...
public class GbtEnumCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1870333207;
     ...
     */
    public GbtEnumCompress() {
        super("gbt_enum_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
