...
public class GeographySpgistPicksplitNd extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1225316200;
     ...
     */
    public GeographySpgistPicksplitNd() {
        super("geography_spgist_picksplit_nd", DefaultSchema.DEFAULT_SCHEMA);
