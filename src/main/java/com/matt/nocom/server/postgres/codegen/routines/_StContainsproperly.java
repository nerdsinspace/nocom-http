...
public class _StContainsproperly extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1430914645;

    /**
     * The parameter <code>_st_containsproperly.RETURN_VALUE</code>.
     */
     ...
     */
    public _StContainsproperly() {
        super("_st_containsproperly", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
