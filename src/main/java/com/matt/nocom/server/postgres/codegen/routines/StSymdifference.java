...
public class StSymdifference extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1645655308;
     ...
     */
    public StSymdifference() {
        super("st_symdifference", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
