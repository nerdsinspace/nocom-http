...
public class _St_3dintersects extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1281782523;

    /**
     * The parameter <code>_st_3dintersects.RETURN_VALUE</code>.
     */
     ...
     */
    public _St_3dintersects() {
        super("_st_3dintersects", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
