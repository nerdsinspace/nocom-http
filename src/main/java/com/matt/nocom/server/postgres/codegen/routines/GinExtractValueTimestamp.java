...
public class GinExtractValueTimestamp extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2051989778;
    ...
    /**
     * The parameter <code>gin_extract_value_timestamp._1</code>.
     */
     ...
     */
    public GinExtractValueTimestamp() {
        super("gin_extract_value_timestamp", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
