...
public class GinComparePrefixName extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 676014778;

    /**
     * The parameter <code>gin_compare_prefix_name.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixName() {
        super("gin_compare_prefix_name", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
