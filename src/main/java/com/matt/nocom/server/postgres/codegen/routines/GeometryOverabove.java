...
public class GeometryOverabove extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1327930589;

    /**
     * The parameter <code>geometry_overabove.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryOverabove() {
        super("geometry_overabove", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
