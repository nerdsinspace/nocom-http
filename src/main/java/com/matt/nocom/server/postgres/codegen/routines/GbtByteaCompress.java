...
public class GbtByteaCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1835116435;
     ...
     */
    public GbtByteaCompress() {
        super("gbt_bytea_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
