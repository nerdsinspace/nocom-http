...
public class GbtIntvDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1926238899;

    /**
     * The parameter <code>gbt_intv_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtIntvDistance() {
        super("gbt_intv_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
