...
public class GbtDateDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 9183184;

    /**
     * The parameter <code>gbt_date_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtDateDistance() {
        super("gbt_date_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
