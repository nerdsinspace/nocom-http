...
public class GbtDateConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 540660539;

    /**
     * The parameter <code>gbt_date_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtDateConsistent() {
        super("gbt_date_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
