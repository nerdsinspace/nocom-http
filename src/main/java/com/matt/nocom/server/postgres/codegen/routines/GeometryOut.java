...
public class GeometryOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2000008624;
     ...
     */
    public GeometryOut() {
        super("geometry_out", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
