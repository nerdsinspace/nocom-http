...
public class GbtInt2Picksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1942710705;
     ...
     */
    public GbtInt2Picksplit() {
        super("gbt_int2_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
