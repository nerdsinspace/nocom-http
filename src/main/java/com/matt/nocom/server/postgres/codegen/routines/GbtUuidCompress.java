...
public class GbtUuidCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1466555921;
     ...
     */
    public GbtUuidCompress() {
        super("gbt_uuid_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
