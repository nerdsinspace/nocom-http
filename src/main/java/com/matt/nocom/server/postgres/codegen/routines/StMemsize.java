...
public class StMemsize extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1222176571;

    /**
     * The parameter <code>st_memsize.RETURN_VALUE</code>.
     */
     ...
     */
    public StMemsize() {
        super("st_memsize", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
