...
public class GeometrySame_3d extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1617455724;

    /**
     * The parameter <code>geometry_same_3d.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometrySame_3d() {
        super("geometry_same_3d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
