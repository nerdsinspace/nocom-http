...
public class GeographySpgistLeafConsistentNd extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1924599830;

    /**
     * The parameter <code>geography_spgist_leaf_consistent_nd.RETURN_VALUE</code>.
     */
     ...
     */
    public GeographySpgistLeafConsistentNd() {
        super("geography_spgist_leaf_consistent_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
