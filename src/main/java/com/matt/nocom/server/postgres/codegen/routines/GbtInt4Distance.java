...
public class GbtInt4Distance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -2032230235;

    /**
     * The parameter <code>gbt_int4_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInt4Distance() {
        super("gbt_int4_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
