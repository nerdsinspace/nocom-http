...
public class GbtOidFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1660786477;
     ...
     */
    public GbtOidFetch() {
        super("gbt_oid_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
