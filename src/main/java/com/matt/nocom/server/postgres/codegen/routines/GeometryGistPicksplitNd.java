...
public class GeometryGistPicksplitNd extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1527082873;
     ...
     */
    public GeometryGistPicksplitNd() {
        super("geometry_gist_picksplit_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
