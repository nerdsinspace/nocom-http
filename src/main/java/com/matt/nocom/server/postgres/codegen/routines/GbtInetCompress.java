...
public class GbtInetCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1732149878;
     ...
     */
    public GbtInetCompress() {
        super("gbt_inet_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
