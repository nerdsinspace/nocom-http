...
public class _StAsx3d extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 166969530;

    /**
     * The parameter <code>_st_asx3d.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>_st_asx3d._1</code>.
     */
     ...
     */
    public _StAsx3d() {
        super("_st_asx3d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
