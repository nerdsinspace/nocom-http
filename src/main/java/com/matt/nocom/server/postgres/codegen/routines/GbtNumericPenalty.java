...
public class GbtNumericPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1986376221;
     ...
     */
    public GbtNumericPenalty() {
        super("gbt_numeric_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
