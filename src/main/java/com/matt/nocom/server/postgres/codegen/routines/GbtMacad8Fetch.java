...
public class GbtMacad8Fetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 829258466;
     ...
     */
    public GbtMacad8Fetch() {
        super("gbt_macad8_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
