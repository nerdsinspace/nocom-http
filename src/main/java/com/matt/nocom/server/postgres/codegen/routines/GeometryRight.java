...
public class GeometryRight extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1234882671;

    /**
     * The parameter <code>geometry_right.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryRight() {
        super("geometry_right", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
