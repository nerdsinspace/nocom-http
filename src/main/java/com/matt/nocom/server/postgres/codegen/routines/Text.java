...
public class Text extends AbstractRoutine<String> {

    private static final long serialVersionUID = -153348379;

    /**
     * The parameter <code>text.RETURN_VALUE</code>.
     */
     ...
     */
    public Text() {
        super("text", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
