...
public class GeometryLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1535170004;

    /**
     * The parameter <code>geometry_le.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryLe() {
        super("geometry_le", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
