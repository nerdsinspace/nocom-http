...
public class StFrechetdistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1813532770;

    /**
     * The parameter <code>st_frechetdistance.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>st_frechetdistance._3</code>.
     */
    public static final Parameter<Double> _3 = Internal.createParameter("_3", org.jooq.impl.SQLDataType.DOUBLE.defaultValue(org.jooq.impl.DSL.field("'-1'::integer", org.jooq.impl.SQLDataType.DOUBLE)), true, true);

    /**
     * Create a new routine call instance
     */
    public StFrechetdistance() {
        super("st_frechetdistance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
