...
public class GeometryWithinNd extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -506665318;

    /**
     * The parameter <code>geometry_within_nd.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryWithinNd() {
        super("geometry_within_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
