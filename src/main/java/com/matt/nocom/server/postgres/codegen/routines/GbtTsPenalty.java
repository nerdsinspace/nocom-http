...
public class GbtTsPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 690718954;
     ...
     */
    public GbtTsPenalty() {
        super("gbt_ts_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
