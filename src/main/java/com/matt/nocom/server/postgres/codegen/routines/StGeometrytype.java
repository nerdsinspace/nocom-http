...
public class StGeometrytype extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -244688576;

    /**
     * The parameter <code>st_geometrytype.RETURN_VALUE</code>.
     */
    ...
    public StGeometrytype() {
        super("st_geometrytype", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
