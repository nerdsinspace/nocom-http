...
public class StDwithin2 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2027272990;

    /**
     * The parameter <code>st_dwithin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>st_dwithin.tolerance</code>.
     */
    ...
    /**
     * The parameter <code>st_dwithin.use_spheroid</code>.
     */
     ...
     */
    public StDwithin2() {
        super("st_dwithin", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
