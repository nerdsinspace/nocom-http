...
public class GeometrySpgistInnerConsistent_2d extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1415444167;
     ...
     */
    public GeometrySpgistInnerConsistent_2d() {
        super("geometry_spgist_inner_consistent_2d", DefaultSchema.DEFAULT_SCHEMA);
