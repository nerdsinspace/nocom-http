...
public class _StCrosses extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1567387955;

    /**
     * The parameter <code>_st_crosses.RETURN_VALUE</code>.
     */
     ...
     */
    public _StCrosses() {
        super("_st_crosses", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
