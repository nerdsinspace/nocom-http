...
public class StDisjoint extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -362822480;

    /**
     * The parameter <code>st_disjoint.RETURN_VALUE</code>.
     */
     ...
     */
    public StDisjoint() {
        super("st_disjoint", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
