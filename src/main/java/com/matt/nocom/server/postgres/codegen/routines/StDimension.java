...
public class StDimension extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = -2081944763;

    /**
     * The parameter <code>st_dimension.RETURN_VALUE</code>.
     */
     ...
     */
    public StDimension() {
        super("st_dimension", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
