...
public class GbtInt2Distance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1066911721;

    /**
     * The parameter <code>gbt_int2_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInt2Distance() {
        super("gbt_int2_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
