...
public class GbtNumericCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1174450297;
     ...
     */
    public GbtNumericCompress() {
        super("gbt_numeric_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
