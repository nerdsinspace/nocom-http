...
public class GbtIntvDecompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2068921020;
     ...
     */
    public GbtIntvDecompress() {
        super("gbt_intv_decompress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
