...
public class GbtTimePenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1378104185;
     ...
     */
    public GbtTimePenalty() {
        super("gbt_time_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
