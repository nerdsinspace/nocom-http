...
public class GbtByteaPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1888273583;
     ...
     */
    public GbtByteaPenalty() {
        super("gbt_bytea_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
