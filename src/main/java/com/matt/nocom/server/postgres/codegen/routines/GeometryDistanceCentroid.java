...
public class GeometryDistanceCentroid extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 621035544;

    /**
     * The parameter <code>geometry_distance_centroid.RETURN_VALUE</code>.
     */
    ...
    public GeometryDistanceCentroid() {
        super("geometry_distance_centroid", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
