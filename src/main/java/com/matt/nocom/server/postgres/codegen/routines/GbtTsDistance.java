...
public class GbtTsDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1633411630;

    /**
     * The parameter <code>gbt_ts_distance.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gbt_ts_distance._2</code>.
     */
     ...
     */
    public GbtTsDistance() {
        super("gbt_ts_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
