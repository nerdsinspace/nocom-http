...
public class StIspolygonccw extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 442883728;

    /**
     * The parameter <code>st_ispolygonccw.RETURN_VALUE</code>.
     */
     ...
     */
    public StIspolygonccw() {
        super("st_ispolygonccw", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
