...
public class StMaxdistance extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1176961372;

    /**
     * The parameter <code>st_maxdistance.RETURN_VALUE</code>.
     */
    ...
    public StMaxdistance() {
        super("st_maxdistance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
