...
public class GinComparePrefixInterval extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1608999478;

    /**
     * The parameter <code>gin_compare_prefix_interval.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixInterval() {
        super("gin_compare_prefix_interval", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
