...
public class GbtOidPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1943063757;
     ...
     */
    public GbtOidPicksplit() {
        super("gbt_oid_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
