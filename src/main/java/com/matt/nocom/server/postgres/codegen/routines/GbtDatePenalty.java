...
public class GbtDatePenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 158183673;
     ...
     */
    public GbtDatePenalty() {
        super("gbt_date_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
