...
public class StIssimple extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1645542896;

    /**
     * The parameter <code>st_issimple.RETURN_VALUE</code>.
     */
     ...
     */
    public StIssimple() {
        super("st_issimple", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
