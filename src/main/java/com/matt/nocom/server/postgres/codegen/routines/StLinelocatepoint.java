...
public class StLinelocatepoint extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 1550121565;

    /**
     * The parameter <code>st_linelocatepoint.RETURN_VALUE</code>.
     */
    ...
    public StLinelocatepoint() {
        super("st_linelocatepoint", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
