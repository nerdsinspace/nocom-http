...
public class GinComparePrefixBytea extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -2144692568;

    /**
     * The parameter <code>gin_compare_prefix_bytea.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixBytea() {
        super("gin_compare_prefix_bytea", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
