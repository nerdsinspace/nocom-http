...
public class GbtTextConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1886033321;

    /**
     * The parameter <code>gbt_text_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtTextConsistent() {
        super("gbt_text_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
