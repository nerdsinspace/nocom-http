...
public class GbtTextCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1414843868;
     ...
     */
    public GbtTextCompress() {
        super("gbt_text_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
