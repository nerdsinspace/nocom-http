...
public class StPointn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2045696389;
    ...
    /**
     * The parameter <code>st_pointn._2</code>.
     */
     ...
     */
    public StPointn() {
        super("st_pointn", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
