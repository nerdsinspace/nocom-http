...
public class StRotatex extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1168543143;
    ...
    /**
     * The parameter <code>st_rotatex._2</code>.
     */
     ...
     */
    public StRotatex() {
        super("st_rotatex", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
