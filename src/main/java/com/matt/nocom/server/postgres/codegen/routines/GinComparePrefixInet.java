...
public class GinComparePrefixInet extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = 640101102;

    /**
     * The parameter <code>gin_compare_prefix_inet.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_inet._3</code>.
     */
    ...
    public GinComparePrefixInet() {
        super("gin_compare_prefix_inet", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
