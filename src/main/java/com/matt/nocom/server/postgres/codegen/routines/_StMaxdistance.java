...
public class _StMaxdistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1800731459;

    /**
     * The parameter <code>_st_maxdistance.RETURN_VALUE</code>.
     */
     ...
     */
    public _StMaxdistance() {
        super("_st_maxdistance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
