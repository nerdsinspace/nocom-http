...
public class _StCovers2 extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 2077591159;

    /**
     * The parameter <code>_st_covers.RETURN_VALUE</code>.
     */
     ...
     */
    public _StCovers2() {
        super("_st_covers", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
