...
public class GbtOidPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1061391487;
     ...
     */
    public GbtOidPenalty() {
        super("gbt_oid_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
