...
public class StRelatematch extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1103233832;

    /**
     * The parameter <code>st_relatematch.RETURN_VALUE</code>.
     */
     ...
     */
    public StRelatematch() {
        super("st_relatematch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
