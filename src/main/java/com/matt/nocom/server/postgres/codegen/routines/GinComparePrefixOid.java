...
public class GinComparePrefixOid extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1416341711;

    /**
     * The parameter <code>gin_compare_prefix_oid.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixOid() {
        super("gin_compare_prefix_oid", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
