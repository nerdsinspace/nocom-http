...
public class GbtByteaConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1630461874;

    /**
     * The parameter <code>gbt_bytea_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtByteaConsistent() {
        super("gbt_bytea_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
