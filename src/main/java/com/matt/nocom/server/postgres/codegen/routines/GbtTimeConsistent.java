...
public class GbtTimeConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1440478632;

    /**
     * The parameter <code>gbt_time_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gbt_time_consistent._2</code>.
     */
    public static final Parameter<Time> _2 = Internal.createParameter("_2", org.jooq.impl.SQLDataType.TIME, false, true);

    /**
     * The parameter <code>gbt_time_consistent._3</code>.
     */
    public static final Parameter<Short> _3 = Internal.createParameter("_3", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>gbt_time_consistent._4</code>.
     */
     ...
     */
    public GbtTimeConsistent() {
        super("gbt_time_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
