...
public class GbtDateCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1381638428;
     ...
     */
    public GbtDateCompress() {
        super("gbt_date_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
