...
public class St_3dperimeter extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 909122082;

    /**
     * The parameter <code>st_3dperimeter.RETURN_VALUE</code>.
     */
    ...
    public St_3dperimeter() {
        super("st_3dperimeter", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
