...
public class GeographyGistCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2050662954;
    ...
    public GeographyGistCompress() {
        super("geography_gist_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
