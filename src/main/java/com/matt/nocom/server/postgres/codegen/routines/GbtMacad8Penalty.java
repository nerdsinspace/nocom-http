...
public class GbtMacad8Penalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1496178926;
     ...
     */
    public GbtMacad8Penalty() {
        super("gbt_macad8_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
