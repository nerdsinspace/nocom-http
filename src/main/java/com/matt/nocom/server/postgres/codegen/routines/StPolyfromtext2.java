...
public class StPolyfromtext2 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2092807050;
     ...
     */
    public StPolyfromtext2() {
        super("st_polyfromtext", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
