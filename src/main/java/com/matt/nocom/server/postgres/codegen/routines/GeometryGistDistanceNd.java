...
public class GeometryGistDistanceNd extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1272755920;

    /**
     * The parameter <code>geometry_gist_distance_nd.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>geometry_gist_distance_nd._3</code>.
     */
     ...
     */
    public GeometryGistDistanceNd() {
        super("geometry_gist_distance_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
