...
public class StPerimeter2d extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 236129547;

    /**
     * The parameter <code>st_perimeter2d.RETURN_VALUE</code>.
     */
    ...
    public StPerimeter2d() {
        super("st_perimeter2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
