...
public class GeometryEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1179838247;

    /**
     * The parameter <code>geometry_eq.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryEq() {
        super("geometry_eq", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
