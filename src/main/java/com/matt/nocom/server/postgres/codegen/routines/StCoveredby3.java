...
public class StCoveredby3 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1913557167;

    /**
     * The parameter <code>st_coveredby.RETURN_VALUE</code>.
     */
     ...
     */
    public StCoveredby3() {
        super("st_coveredby", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
