...
public class GinComparePrefixBit extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1687257628;

    /**
     * The parameter <code>gin_compare_prefix_bit.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixBit() {
        super("gin_compare_prefix_bit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
