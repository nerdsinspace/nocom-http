...
public class StY extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -529676065;

    /**
     * The parameter <code>st_y.RETURN_VALUE</code>.
     */
     ...
     */
    public StY() {
        super("st_y", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
