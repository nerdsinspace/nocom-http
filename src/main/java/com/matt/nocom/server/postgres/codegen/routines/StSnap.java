...
public class StSnap extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1197511865;
    ...
    /**
     * The parameter <code>st_snap._3</code>.
     */
     ...
     */
    public StSnap() {
        super("st_snap", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
