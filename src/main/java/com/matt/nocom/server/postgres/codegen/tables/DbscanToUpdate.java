...
public class DbscanToUpdate extends TableImpl<DbscanToUpdateRecord> {
    ...
    private static final long serialVersionUID = -907741914;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.DBSCAN_TO_UPDATE_PKEY);
    }
    ...
    public List<ForeignKey<DbscanToUpdateRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DbscanToUpdateRecord, ?>>asList(Keys.DBSCAN_TO_UPDATE__DBSCAN_TO_UPDATE_DBSCAN_ID_FKEY);
    }

    public Dbscan dbscan() {
        return new Dbscan(this, Keys.DBSCAN_TO_UPDATE__DBSCAN_TO_UPDATE_DBSCAN_ID_FKEY);
    }
