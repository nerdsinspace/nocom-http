...
public class GinExtractValueVarbit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 995370947;
    ...
    /**
     * The parameter <code>gin_extract_value_varbit._1</code>.
     */
     ...
     */
    public GinExtractValueVarbit() {
        super("gin_extract_value_varbit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
