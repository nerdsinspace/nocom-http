...
public class GbtBitCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 521035001;
     ...
     */
    public GbtBitCompress() {
        super("gbt_bit_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
