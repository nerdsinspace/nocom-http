...
public class StIscollection extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1137433451;

    /**
     * The parameter <code>st_iscollection.RETURN_VALUE</code>.
     */
     ...
     */
    public StIscollection() {
        super("st_iscollection", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
