...
public class GinComparePrefixCidr extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1065211918;

    /**
     * The parameter <code>gin_compare_prefix_cidr.RETURN_VALUE</code>.
     */
     ...
     */
    @java.lang.Deprecated
    public static final Parameter<Object> _2 = Internal.createParameter("_2", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cidr\""), false, true);

    /**
     * The parameter <code>gin_compare_prefix_cidr._3</code>.
     */
     ...
     */
    public GinComparePrefixCidr() {
        super("gin_compare_prefix_cidr", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
