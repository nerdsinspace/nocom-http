...
public class GbtDateFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1930847158;
     ...
     */
    public GbtDateFetch() {
        super("gbt_date_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
