...
public class GeometrySame extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1453707628;

    /**
     * The parameter <code>geometry_same.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometrySame() {
        super("geometry_same", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
