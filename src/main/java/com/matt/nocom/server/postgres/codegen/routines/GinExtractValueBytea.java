...
public class GinExtractValueBytea extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 31802394;
    ...
    /**
     * The parameter <code>gin_extract_value_bytea._1</code>.
     */
     ...
     */
    public GinExtractValueBytea() {
        super("gin_extract_value_bytea", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
