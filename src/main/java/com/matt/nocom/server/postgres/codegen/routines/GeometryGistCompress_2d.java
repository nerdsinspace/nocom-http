...
public class GeometryGistCompress_2d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2000948207;
    ...
    public GeometryGistCompress_2d() {
        super("geometry_gist_compress_2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
