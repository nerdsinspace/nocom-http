...
public class StIsring extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1391007125;

    /**
     * The parameter <code>st_isring.RETURN_VALUE</code>.
     */
     ...
     */
    public StIsring() {
        super("st_isring", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
