...
public class GbtFloat8Penalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 295440103;
     ...
     */
    public GbtFloat8Penalty() {
        super("gbt_float8_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
