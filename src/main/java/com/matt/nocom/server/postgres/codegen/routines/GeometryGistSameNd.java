...
public class GeometryGistSameNd extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -887781279;
     ...
     */
    public GeometryGistSameNd() {
        super("geometry_gist_same_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
