...
public class GbtTextPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 493633403;
     ...
     */
    public GbtTextPicksplit() {
        super("gbt_text_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
