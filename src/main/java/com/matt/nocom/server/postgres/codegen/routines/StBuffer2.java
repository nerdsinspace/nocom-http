...
public class StBuffer2 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 752842545;
    ...
    /**
     * The parameter <code>st_buffer.quadsegs</code>.
     */
    public static final Parameter<Integer> QUADSEGS = Internal.createParameter("quadsegs", org.jooq.impl.SQLDataType.INTEGER, false, false);
     ...
     */
    public void setQuadsegs(Integer value) {
        setValue(QUADSEGS, value);
    }

    /**
     * Set the <code>quadsegs</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    public void setQuadsegs(Field<Integer> field) {
        setField(QUADSEGS, field);
    }
}
