...
public class GbtTimeFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1168116344;
     ...
     */
    public GbtTimeFetch() {
        super("gbt_time_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
