...
public class GbtInt8Picksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 420927288;
     ...
     */
    public GbtInt8Picksplit() {
        super("gbt_int8_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
