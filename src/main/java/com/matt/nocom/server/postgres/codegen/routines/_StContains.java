...
public class _StContains extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1060611580;

    /**
     * The parameter <code>_st_contains.RETURN_VALUE</code>.
     */
     ...
     */
    public _StContains() {
        super("_st_contains", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
