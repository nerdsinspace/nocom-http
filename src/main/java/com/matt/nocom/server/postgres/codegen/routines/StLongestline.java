...
public class StLongestline extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1820660894;
     ...
     */
    public StLongestline() {
        super("st_longestline", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
