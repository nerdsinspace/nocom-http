...
public class GbtInt8Penalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1169610581;
     ...
     */
    public GbtInt8Penalty() {
        super("gbt_int8_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
