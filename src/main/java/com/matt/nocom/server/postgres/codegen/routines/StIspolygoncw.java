...
public class StIspolygoncw extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1179393856;

    /**
     * The parameter <code>st_ispolygoncw.RETURN_VALUE</code>.
     */
     ...
     */
    public StIspolygoncw() {
        super("st_ispolygoncw", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
