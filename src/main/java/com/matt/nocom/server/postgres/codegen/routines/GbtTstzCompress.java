...
public class GbtTstzCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1826992165;
     ...
     */
    public GbtTstzCompress() {
        super("gbt_tstz_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
