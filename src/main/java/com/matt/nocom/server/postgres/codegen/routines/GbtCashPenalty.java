...
public class GbtCashPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 221006046;
     ...
     */
    public GbtCashPenalty() {
        super("gbt_cash_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
