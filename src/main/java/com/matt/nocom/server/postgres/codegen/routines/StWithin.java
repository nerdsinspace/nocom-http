...
public class StWithin extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1566703275;

    /**
     * The parameter <code>st_within.RETURN_VALUE</code>.
     */
     ...
     */
    public StWithin() {
        super("st_within", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
