...
public class StDistancesphere extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1650624772;

    /**
     * The parameter <code>st_distancesphere.RETURN_VALUE</code>.
     */
     ...
     */
    public StDistancesphere() {
        super("st_distancesphere", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
