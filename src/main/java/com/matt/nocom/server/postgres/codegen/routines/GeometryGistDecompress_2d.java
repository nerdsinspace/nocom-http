...
public class GeometryGistDecompress_2d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1101770515;
     ...
     */
    public GeometryGistDecompress_2d() {
        super("geometry_gist_decompress_2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
