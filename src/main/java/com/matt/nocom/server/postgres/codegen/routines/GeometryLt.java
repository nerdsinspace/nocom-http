...
public class GeometryLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1370992364;

    /**
     * The parameter <code>geometry_lt.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryLt() {
        super("geometry_lt", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
