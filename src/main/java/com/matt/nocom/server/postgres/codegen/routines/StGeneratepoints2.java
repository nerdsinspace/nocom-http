...
public class StGeneratepoints2 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1458299924;
    ...
    /**
     * The parameter <code>st_generatepoints.seed</code>.
     */
    public static final Parameter<Integer> SEED = Internal.createParameter("seed", org.jooq.impl.SQLDataType.INTEGER, false, false);
    ...
    /**
     * Set the <code>seed</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
