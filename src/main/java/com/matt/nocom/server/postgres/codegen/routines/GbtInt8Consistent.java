...
public class GbtInt8Consistent extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 2127988958;

    /**
     * The parameter <code>gbt_int8_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtInt8Consistent() {
        super("gbt_int8_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
