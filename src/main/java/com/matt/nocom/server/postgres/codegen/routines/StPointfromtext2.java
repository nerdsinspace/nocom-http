...
public class StPointfromtext2 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1563227301;
     ...
     */
    public StPointfromtext2() {
        super("st_pointfromtext", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
