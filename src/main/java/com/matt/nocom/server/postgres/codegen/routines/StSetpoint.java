...
public class StSetpoint extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 685721464;
    ...
    /**
     * The parameter <code>st_setpoint._2</code>.
     */
     ...
     */
    public StSetpoint() {
        super("st_setpoint", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
