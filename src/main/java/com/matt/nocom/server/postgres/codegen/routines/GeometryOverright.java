...
public class GeometryOverright extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2076349540;

    /**
     * The parameter <code>geometry_overright.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryOverright() {
        super("geometry_overright", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
