...
public class StZ extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -672658431;

    /**
     * The parameter <code>st_z.RETURN_VALUE</code>.
     */
     ...
     */
    public StZ() {
        super("st_z", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
