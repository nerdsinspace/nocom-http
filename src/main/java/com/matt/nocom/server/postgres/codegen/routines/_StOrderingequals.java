...
public class _StOrderingequals extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1525028532;

    /**
     * The parameter <code>_st_orderingequals.RETURN_VALUE</code>.
     */
     ...
     */
    public _StOrderingequals() {
        super("_st_orderingequals", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
