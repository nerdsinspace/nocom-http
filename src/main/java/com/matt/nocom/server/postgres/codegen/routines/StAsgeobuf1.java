...
public class StAsgeobuf1 extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 583547399;

    /**
     * The parameter <code>st_asgeobuf.RETURN_VALUE</code>.
     */
     ...
     */
    public StAsgeobuf1() {
        super("st_asgeobuf", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BLOB);
