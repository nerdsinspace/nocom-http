...
public class GbtBpcharConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 345250712;

    /**
     * The parameter <code>gbt_bpchar_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtBpcharConsistent() {
        super("gbt_bpchar_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
