...
public class StGeometryn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1359321688;
    ...
    /**
     * The parameter <code>st_geometryn._2</code>.
     */
     ...
     */
    public StGeometryn() {
        super("st_geometryn", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
