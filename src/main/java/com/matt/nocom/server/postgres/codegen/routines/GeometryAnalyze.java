...
public class GeometryAnalyze extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1282962013;

    /**
     * The parameter <code>geometry_analyze.RETURN_VALUE</code>.
     */
    ...
    public GeometryAnalyze() {
        super("geometry_analyze", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
