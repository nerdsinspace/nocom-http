...
public class StPerimeter1 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 201990113;

    /**
     * The parameter <code>st_perimeter.RETURN_VALUE</code>.
     */
     ...
     */
    public StPerimeter1() {
        super("st_perimeter", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
