...
public class StArea2d extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -311742635;

    /**
     * The parameter <code>st_area2d.RETURN_VALUE</code>.
     */
     ...
     */
    public StArea2d() {
        super("st_area2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
