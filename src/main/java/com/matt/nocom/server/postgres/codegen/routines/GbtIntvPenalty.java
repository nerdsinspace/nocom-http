...
public class GbtIntvPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1566302610;
     ...
     */
    public GbtIntvPenalty() {
        super("gbt_intv_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
