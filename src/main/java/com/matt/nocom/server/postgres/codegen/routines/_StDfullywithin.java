...
public class _StDfullywithin extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1577582655;

    /**
     * The parameter <code>_st_dfullywithin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>_st_dfullywithin._3</code>.
     */
     ...
     */
    public _StDfullywithin() {
        super("_st_dfullywithin", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
