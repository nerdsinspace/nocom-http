...
public class GeometrySpgistCompress_3d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1071937835;
     ...
     */
    public GeometrySpgistCompress_3d() {
        super("geometry_spgist_compress_3d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
