...
public class PostgisIndexSupportfn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1476657802;
     ...
     */
    public PostgisIndexSupportfn() {
        super("postgis_index_supportfn", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
