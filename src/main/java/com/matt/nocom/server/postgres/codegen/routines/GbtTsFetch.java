...
public class GbtTsFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1827060602;
     ...
     */
    public GbtTsFetch() {
        super("gbt_ts_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
