...
public class StContains extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1394734480;

    /**
     * The parameter <code>st_contains.RETURN_VALUE</code>.
     */
     ...
     */
    public StContains() {
        super("st_contains", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
