...
public class GinComparePrefixBool extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1994489571;

    /**
     * The parameter <code>gin_compare_prefix_bool.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_bool._1</code>.
     */
    public static final Parameter<Boolean> _1 = Internal.createParameter("_1", org.jooq.impl.SQLDataType.BOOLEAN, false, true);

    /**
     * The parameter <code>gin_compare_prefix_bool._2</code>.
     */
    public static final Parameter<Boolean> _2 = Internal.createParameter("_2", org.jooq.impl.SQLDataType.BOOLEAN, false, true);

    /**
     * The parameter <code>gin_compare_prefix_bool._3</code>.
     */
     ...
     */
    public GinComparePrefixBool() {
        super("gin_compare_prefix_bool", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
