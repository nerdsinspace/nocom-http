...
public class GbtOidConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2030053603;

    /**
     * The parameter <code>gbt_oid_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtOidConsistent() {
        super("gbt_oid_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
