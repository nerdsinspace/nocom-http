...
public class GbtBitConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1732749792;

    /**
     * The parameter <code>gbt_bit_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtBitConsistent() {
        super("gbt_bit_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
