...
public class StSimplifyvw extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1875151300;
    ...
    /**
     * The parameter <code>st_simplifyvw._2</code>.
     */
     ...
     */
    public StSimplifyvw() {
        super("st_simplifyvw", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
