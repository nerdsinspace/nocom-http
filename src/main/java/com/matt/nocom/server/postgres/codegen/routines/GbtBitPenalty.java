...
public class GbtBitPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1961699555;
     ...
     */
    public GbtBitPenalty() {
        super("gbt_bit_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
