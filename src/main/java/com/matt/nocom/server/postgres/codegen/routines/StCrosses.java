...
public class StCrosses extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1772874103;

    /**
     * The parameter <code>st_crosses.RETURN_VALUE</code>.
     */
     ...
     */
    public StCrosses() {
        super("st_crosses", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
