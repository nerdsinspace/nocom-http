...
public class GinExtractValueUuid extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -518773322;
    ...
    /**
     * The parameter <code>gin_extract_value_uuid._1</code>.
     */
     ...
     */
    public GinExtractValueUuid() {
        super("gin_extract_value_uuid", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
