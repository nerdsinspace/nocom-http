...
public class GinExtractValueDate extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 809882833;
    ...
    /**
     * The parameter <code>gin_extract_value_date._1</code>.
     */
     ...
     */
    public GinExtractValueDate() {
        super("gin_extract_value_date", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
