...
public class GeographyGistUnion extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 630883526;
    ...
    /**
     * The parameter <code>geography_gist_union._1</code>.
     */
     ...
     */
    public GeographyGistUnion() {
        super("geography_gist_union", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
