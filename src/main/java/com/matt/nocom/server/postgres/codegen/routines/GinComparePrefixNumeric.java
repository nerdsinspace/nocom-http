...
public class GinComparePrefixNumeric extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -952853223;

    /**
     * The parameter <code>gin_compare_prefix_numeric.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixNumeric() {
        super("gin_compare_prefix_numeric", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
