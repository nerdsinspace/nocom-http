...
public class GbtInt4Penalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2078045137;
     ...
     */
    public GbtInt4Penalty() {
        super("gbt_int4_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
