...
public class GbtFloat4Fetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1097343757;
     ...
     */
    public GbtFloat4Fetch() {
        super("gbt_float4_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
