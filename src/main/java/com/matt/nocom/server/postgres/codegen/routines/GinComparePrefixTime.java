...
public class GinComparePrefixTime extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1791838321;

    /**
     * The parameter <code>gin_compare_prefix_time.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixTime() {
        super("gin_compare_prefix_time", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
