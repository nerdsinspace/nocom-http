...
public class GbtTextPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1590870632;
     ...
     */
    public GbtTextPenalty() {
        super("gbt_text_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
