...
public class GeometryGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1457892564;

    /**
     * The parameter <code>geometry_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryGt() {
        super("geometry_gt", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
