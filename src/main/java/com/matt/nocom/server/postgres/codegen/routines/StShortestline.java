...
public class StShortestline extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1079170725;
     ...
     */
    public StShortestline() {
        super("st_shortestline", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
