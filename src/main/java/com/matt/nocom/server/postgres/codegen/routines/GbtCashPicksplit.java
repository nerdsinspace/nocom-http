...
public class GbtCashPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1362025726;
     ...
     */
    public GbtCashPicksplit() {
        super("gbt_cash_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
