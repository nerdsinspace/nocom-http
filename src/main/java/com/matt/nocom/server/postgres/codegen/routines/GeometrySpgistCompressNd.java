...
public class GeometrySpgistCompressNd extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1019508180;
     ...
     */
    public GeometrySpgistCompressNd() {
        super("geometry_spgist_compress_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
