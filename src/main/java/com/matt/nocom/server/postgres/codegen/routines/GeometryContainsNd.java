...
public class GeometryContainsNd extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 1045862165;

    /**
     * The parameter <code>geometry_contains_nd.RETURN_VALUE</code>.
     */
    ...
    public GeometryContainsNd() {
        super("geometry_contains_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
