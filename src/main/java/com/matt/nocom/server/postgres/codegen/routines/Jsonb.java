...
public class Jsonb extends AbstractRoutine<JSONB> {

    private static final long serialVersionUID = -1141321258;

    /**
     * The parameter <code>jsonb.RETURN_VALUE</code>.
     */
     ...
     */
    public Jsonb() {
        super("jsonb", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.JSONB);
