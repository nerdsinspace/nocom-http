...
public class StRemoverepeatedpoints extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1716595344;
    ...
    /**
     * The parameter <code>st_removerepeatedpoints.tolerance</code>.
     */
    ...
    public StRemoverepeatedpoints() {
        super("st_removerepeatedpoints", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
