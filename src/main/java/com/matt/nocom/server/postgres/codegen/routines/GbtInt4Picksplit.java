...
public class GbtInt4Picksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 315549620;
     ...
     */
    public GbtInt4Picksplit() {
        super("gbt_int4_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
