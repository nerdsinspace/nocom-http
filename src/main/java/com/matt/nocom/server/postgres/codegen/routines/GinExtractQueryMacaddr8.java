...
public class GinExtractQueryMacaddr8 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2012950588;
    ...
    /**
     * The parameter <code>gin_extract_query_macaddr8._3</code>.
     */
     ...
     */
    public GinExtractQueryMacaddr8() {
        super("gin_extract_query_macaddr8", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
