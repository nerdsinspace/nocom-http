...
public class GeometryOverbelow extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2116482419;

    /**
     * The parameter <code>geometry_overbelow.RETURN_VALUE</code>.
     */
    ...
    public GeometryOverbelow() {
        super("geometry_overbelow", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
