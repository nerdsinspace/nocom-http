...
public class GbtEnumPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1346122992;
     ...
     */
    public GbtEnumPicksplit() {
        super("gbt_enum_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
