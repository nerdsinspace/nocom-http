...
public class GbtFloat4Consistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1488833210;

    /**
     * The parameter <code>gbt_float4_consistent.RETURN_VALUE</code>.
     */
    ...
    public GbtFloat4Consistent() {
        super("gbt_float4_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
