...
public class St_3dmaxdistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1252947885;

    /**
     * The parameter <code>st_3dmaxdistance.RETURN_VALUE</code>.
     */
     ...
     */
    public St_3dmaxdistance() {
        super("st_3dmaxdistance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
