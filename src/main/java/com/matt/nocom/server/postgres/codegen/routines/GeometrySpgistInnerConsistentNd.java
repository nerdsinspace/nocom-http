...
public class GeometrySpgistInnerConsistentNd extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -491803852;
    ...
    public GeometrySpgistInnerConsistentNd() {
        super("geometry_spgist_inner_consistent_nd", DefaultSchema.DEFAULT_SCHEMA);
