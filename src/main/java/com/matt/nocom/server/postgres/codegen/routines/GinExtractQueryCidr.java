...
public class GinExtractQueryCidr extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -129425592;
    ...
    /**
     * The parameter <code>gin_extract_query_cidr._3</code>.
     */
     ...
     */
    public GinExtractQueryCidr() {
        super("gin_extract_query_cidr", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
