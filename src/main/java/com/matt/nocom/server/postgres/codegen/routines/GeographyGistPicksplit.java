...
public class GeographyGistPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1951125937;
    ...
    public GeographyGistPicksplit() {
        super("geography_gist_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
