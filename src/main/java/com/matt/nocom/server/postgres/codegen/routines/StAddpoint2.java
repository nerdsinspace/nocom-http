...
public class StAddpoint2 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1610420957;
    ...
    /**
     * The parameter <code>st_addpoint._3</code>.
     */
     ...
     */
    public StAddpoint2() {
        super("st_addpoint", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
