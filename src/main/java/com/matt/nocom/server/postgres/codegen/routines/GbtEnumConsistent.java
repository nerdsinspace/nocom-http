...
public class GbtEnumConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1464941614;

    /**
     * The parameter <code>gbt_enum_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtEnumConsistent() {
        super("gbt_enum_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
