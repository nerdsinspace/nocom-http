...
public class _StCoveredby2 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2121658260;

    /**
     * The parameter <code>_st_coveredby.RETURN_VALUE</code>.
     */
     ...
     */
    public _StCoveredby2() {
        super("_st_coveredby", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
