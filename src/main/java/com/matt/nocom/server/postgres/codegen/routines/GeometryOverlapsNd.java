...
public class GeometryOverlapsNd extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -951685995;

    /**
     * The parameter <code>geometry_overlaps_nd.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryOverlapsNd() {
        super("geometry_overlaps_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
