...
public class StForce3dz extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1227488351;
     ...
     */
    public StForce3dz() {
        super("st_force3dz", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
