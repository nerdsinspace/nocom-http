...
public class GbtUuidPenalty extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1542648999;
     ...
     */
    public GbtUuidPenalty() {
        super("gbt_uuid_penalty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
