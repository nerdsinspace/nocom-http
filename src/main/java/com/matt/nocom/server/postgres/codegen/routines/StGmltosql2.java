...
public class StGmltosql2 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1807961772;
     ...
     */
    public StGmltosql2() {
        super("st_gmltosql", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
