...
public class CashDist extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1984261883;
     ...
     */
    public CashDist() {
        super("cash_dist", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"money\""));
