...
public class PostgisHasbbox extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1423578197;

    /**
     * The parameter <code>postgis_hasbbox.RETURN_VALUE</code>.
     */
    ...
    public PostgisHasbbox() {
        super("postgis_hasbbox", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
