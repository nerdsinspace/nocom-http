...
public class GbtFloat4Picksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 789566279;
     ...
     */
    public GbtFloat4Picksplit() {
        super("gbt_float4_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
