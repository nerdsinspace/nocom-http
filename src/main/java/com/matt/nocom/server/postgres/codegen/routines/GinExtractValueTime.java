...
public class GinExtractValueTime extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1537138320;
    ...
    /**
     * The parameter <code>gin_extract_value_time._1</code>.
     */
     ...
     */
    public GinExtractValueTime() {
        super("gin_extract_value_time", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
