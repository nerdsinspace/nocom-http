...
public class GbtTstzDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1480451968;

    /**
     * The parameter <code>gbt_tstz_distance.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gbt_tstz_distance._2</code>.
     */
     ...
     */
    public GbtTstzDistance() {
        super("gbt_tstz_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
