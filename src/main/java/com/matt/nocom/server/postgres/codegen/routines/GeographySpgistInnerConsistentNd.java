...
public class GeographySpgistInnerConsistentNd extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1404855433;
     ...
     */
    public GeographySpgistInnerConsistentNd() {
        super("geography_spgist_inner_consistent_nd", DefaultSchema.DEFAULT_SCHEMA);
