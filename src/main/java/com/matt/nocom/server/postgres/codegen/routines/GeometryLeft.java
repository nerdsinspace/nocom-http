...
public class GeometryLeft extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 1639459175;

    /**
     * The parameter <code>geometry_left.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryLeft() {
        super("geometry_left", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
