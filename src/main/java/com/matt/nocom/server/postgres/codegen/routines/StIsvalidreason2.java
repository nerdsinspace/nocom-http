...
public class StIsvalidreason2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1197643852;

    /**
     * The parameter <code>st_isvalidreason.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>st_isvalidreason._2</code>.
     */
     ...
     */
    public StIsvalidreason2() {
        super("st_isvalidreason", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
