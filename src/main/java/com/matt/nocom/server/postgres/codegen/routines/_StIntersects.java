...
public class _StIntersects extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1600882128;

    /**
     * The parameter <code>_st_intersects.RETURN_VALUE</code>.
     */
     ...
     */
    public _StIntersects() {
        super("_st_intersects", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
