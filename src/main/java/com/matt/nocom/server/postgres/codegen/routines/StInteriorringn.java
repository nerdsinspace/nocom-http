...
public class StInteriorringn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1083836072;
    ...
    /**
     * The parameter <code>st_interiorringn._2</code>.
     */
     ...
     */
    public StInteriorringn() {
        super("st_interiorringn", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
