...
public class GserializedGistJoinselNd extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1669430572;

    /**
     * The parameter <code>gserialized_gist_joinsel_nd.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gserialized_gist_joinsel_nd._2</code>.
     */
    ...
    /**
     * The parameter <code>gserialized_gist_joinsel_nd._4</code>.
     */
    public static final Parameter<Short> _4 = Internal.createParameter("_4", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * Create a new routine call instance
     */
    public GserializedGistJoinselNd() {
        super("gserialized_gist_joinsel_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
