...
public class GinExtractValueInt8 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -859871648;
    ...
    /**
     * The parameter <code>gin_extract_value_int8._1</code>.
     */
     ...
     */
    public GinExtractValueInt8() {
        super("gin_extract_value_int8", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
