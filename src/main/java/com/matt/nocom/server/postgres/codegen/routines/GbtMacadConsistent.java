...
public class GbtMacadConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1470390029;

    /**
     * The parameter <code>gbt_macad_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtMacadConsistent() {
        super("gbt_macad_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
