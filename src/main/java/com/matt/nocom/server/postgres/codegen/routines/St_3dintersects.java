...
public class St_3dintersects extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1122609008;

    /**
     * The parameter <code>st_3dintersects.RETURN_VALUE</code>.
     */
    ...
    public St_3dintersects() {
        super("st_3dintersects", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
