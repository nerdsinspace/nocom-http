...
public class GbtIntvConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 106786028;

    /**
     * The parameter <code>gbt_intv_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtIntvConsistent() {
        super("gbt_intv_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
