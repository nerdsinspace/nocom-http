...
public class StAstwkb2 extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1144189321;
    ...
    /**
     * The parameter <code>st_astwkb.geom</code>.
     */
    public static final Parameter<Object[]> GEOM = Internal.createParameter("geom", org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\"").getArrayDataType(), false, false);

    /**
     * The parameter <code>st_astwkb.ids</code>.
     */
    public static final Parameter<Long[]> IDS = Internal.createParameter("ids", org.jooq.impl.SQLDataType.BIGINT.getArrayDataType(), false, false);
    ...
    /**
     * Set the <code>ids</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    public void setIds(Field<Long[]> field) {
        setField(IDS, field);
    }
