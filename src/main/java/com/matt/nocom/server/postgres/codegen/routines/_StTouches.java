...
public class _StTouches extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2075684365;

    /**
     * The parameter <code>_st_touches.RETURN_VALUE</code>.
     */
     ...
     */
    public _StTouches() {
        super("_st_touches", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
