...
public class GeographySpgistChooseNd extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1237240877;
     ...
     */
    public GeographySpgistChooseNd() {
        super("geography_spgist_choose_nd", DefaultSchema.DEFAULT_SCHEMA);
