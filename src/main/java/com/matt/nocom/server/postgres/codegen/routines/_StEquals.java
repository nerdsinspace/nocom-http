...
public class _StEquals extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 572556471;

    /**
     * The parameter <code>_st_equals.RETURN_VALUE</code>.
     */
     ...
     */
    public _StEquals() {
        super("_st_equals", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
