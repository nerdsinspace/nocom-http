...
public class GeographyGistConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1306395511;

    /**
     * The parameter <code>geography_gist_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>geography_gist_consistent._3</code>.
     */
     ...
     */
    public GeographyGistConsistent() {
        super("geography_gist_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
