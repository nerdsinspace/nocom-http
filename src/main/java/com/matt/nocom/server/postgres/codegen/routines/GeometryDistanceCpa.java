...
public class GeometryDistanceCpa extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1341280460;

    /**
     * The parameter <code>geometry_distance_cpa.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryDistanceCpa() {
        super("geometry_distance_cpa", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
