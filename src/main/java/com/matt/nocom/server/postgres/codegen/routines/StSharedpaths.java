...
public class StSharedpaths extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1569477860;
    ...
    public StSharedpaths() {
        super("st_sharedpaths", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
