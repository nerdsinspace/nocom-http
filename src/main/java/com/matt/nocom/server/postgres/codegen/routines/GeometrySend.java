...
public class GeometrySend extends AbstractRoutine<byte[]> {
    ...
    private static final long serialVersionUID = 1705823145;

    /**
     * The parameter <code>geometry_send.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometrySend() {
        super("geometry_send", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BLOB);
