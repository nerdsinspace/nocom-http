...
public class StRelate1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1594783179;

    /**
     * The parameter <code>st_relate.RETURN_VALUE</code>.
     */
     ...
     */
    public StRelate1() {
        super("st_relate", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.CLOB);
