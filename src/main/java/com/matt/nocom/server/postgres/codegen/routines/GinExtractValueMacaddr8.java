...
public class GinExtractValueMacaddr8 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1327316990;
     ...
     */
    public GinExtractValueMacaddr8() {
        super("gin_extract_value_macaddr8", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
