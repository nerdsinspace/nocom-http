...
public class GinExtractValueTimetz extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 141522840;
    ...
    /**
     * The parameter <code>gin_extract_value_timetz._1</code>.
     */
     ...
     */
    public GinExtractValueTimetz() {
        super("gin_extract_value_timetz", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
