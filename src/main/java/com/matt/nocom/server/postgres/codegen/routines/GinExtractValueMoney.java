...
public class GinExtractValueMoney extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -294695830;
     ...
     */
    public GinExtractValueMoney() {
        super("gin_extract_value_money", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
