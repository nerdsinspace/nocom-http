...
public class GbtCashCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1506633591;
     ...
     */
    public GbtCashCompress() {
        super("gbt_cash_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
