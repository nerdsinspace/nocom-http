...
public class GbtInt2Consistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -666816340;

    /**
     * The parameter <code>gbt_int2_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtInt2Consistent() {
        super("gbt_int2_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
