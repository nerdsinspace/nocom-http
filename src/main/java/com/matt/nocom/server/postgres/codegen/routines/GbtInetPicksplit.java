...
public class GbtInetPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1052518910;
     ...
     */
    public GbtInetPicksplit() {
        super("gbt_inet_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
