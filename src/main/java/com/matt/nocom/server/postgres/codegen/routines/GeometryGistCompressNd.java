...
public class GeometryGistCompressNd extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1713518825;
    ...
    public GeometryGistCompressNd() {
        super("geometry_gist_compress_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
