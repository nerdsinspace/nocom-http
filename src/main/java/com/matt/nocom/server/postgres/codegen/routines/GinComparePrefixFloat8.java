...
public class GinComparePrefixFloat8 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1132349765;

    /**
     * The parameter <code>gin_compare_prefix_float8.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixFloat8() {
        super("gin_compare_prefix_float8", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
