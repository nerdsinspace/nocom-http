...
public class GinExtractValueBool extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1862958869;
    ...
    /**
     * The parameter <code>gin_extract_value_bool._1</code>.
     */
     ...
     */
    public GinExtractValueBool() {
        super("gin_extract_value_bool", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
