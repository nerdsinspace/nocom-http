...
public class GbtMacadPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2127389781;
     ...
     */
    public GbtMacadPicksplit() {
        super("gbt_macad_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
