...
public class GinExtractValueOid extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1840402620;
    ...
    /**
     * The parameter <code>gin_extract_value_oid._1</code>.
     */
     ...
     */
    public GinExtractValueOid() {
        super("gin_extract_value_oid", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
