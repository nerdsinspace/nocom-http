...
public class GbtUuidConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1211365880;

    /**
     * The parameter <code>gbt_uuid_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtUuidConsistent() {
        super("gbt_uuid_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
