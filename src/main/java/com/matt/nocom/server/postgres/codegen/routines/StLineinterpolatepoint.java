...
public class StLineinterpolatepoint extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -2064176795;
    ...
    /**
     * The parameter <code>st_lineinterpolatepoint._2</code>.
     */
    ...
    public StLineinterpolatepoint() {
        super("st_lineinterpolatepoint", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
