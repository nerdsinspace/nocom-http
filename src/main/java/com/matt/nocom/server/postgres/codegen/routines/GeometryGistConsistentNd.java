...
public class GeometryGistConsistentNd extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 512897015;

    /**
     * The parameter <code>geometry_gist_consistent_nd.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>geometry_gist_consistent_nd._3</code>.
     */
    ...
    public GeometryGistConsistentNd() {
        super("geometry_gist_consistent_nd", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
