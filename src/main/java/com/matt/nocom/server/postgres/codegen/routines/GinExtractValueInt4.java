...
public class GinExtractValueInt4 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1753281621;
    ...
    /**
     * The parameter <code>gin_extract_value_int4._1</code>.
     */
     ...
     */
    public GinExtractValueInt4() {
        super("gin_extract_value_int4", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
