...
public class GbtTsConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1204745539;

    /**
     * The parameter <code>gbt_ts_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gbt_ts_consistent._2</code>.
     */
     ...
     */
    public GbtTsConsistent() {
        super("gbt_ts_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
