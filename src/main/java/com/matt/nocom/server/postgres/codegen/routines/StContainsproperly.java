...
public class StContainsproperly extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1852958032;

    /**
     * The parameter <code>st_containsproperly.RETURN_VALUE</code>.
     */
     ...
     */
    public StContainsproperly() {
        super("st_containsproperly", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
