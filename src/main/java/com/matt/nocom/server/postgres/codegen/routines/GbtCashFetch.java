...
public class GbtCashFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1430903983;
     ...
     */
    public GbtCashFetch() {
        super("gbt_cash_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
