...
public class GbtBpcharCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1745556838;
     ...
     */
    public GbtBpcharCompress() {
        super("gbt_bpchar_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
