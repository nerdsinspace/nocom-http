...
public class GeometryOverlaps extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1974849516;

    /**
     * The parameter <code>geometry_overlaps.RETURN_VALUE</code>.
     */
    ...
    public GeometryOverlaps() {
        super("geometry_overlaps", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
