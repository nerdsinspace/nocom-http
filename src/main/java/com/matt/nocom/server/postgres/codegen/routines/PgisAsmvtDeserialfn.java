...
public class PgisAsmvtDeserialfn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1783723907;
    ...
    /**
     * The parameter <code>pgis_asmvt_deserialfn._1</code>.
     */
     ...
     */
    public PgisAsmvtDeserialfn() {
        super("pgis_asmvt_deserialfn", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
