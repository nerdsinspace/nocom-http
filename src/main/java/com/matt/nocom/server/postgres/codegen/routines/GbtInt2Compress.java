...
public class GbtInt2Compress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2120575353;
     ...
     */
    public GbtInt2Compress() {
        super("gbt_int2_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
