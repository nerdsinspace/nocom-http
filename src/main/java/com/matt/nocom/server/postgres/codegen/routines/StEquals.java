...
public class StEquals extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1506211243;

    /**
     * The parameter <code>st_equals.RETURN_VALUE</code>.
     */
     ...
     */
    public StEquals() {
        super("st_equals", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
