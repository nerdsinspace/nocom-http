...
public class GbtTimetzCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1625942730;
     ...
     */
    public GbtTimetzCompress() {
        super("gbt_timetz_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
