...
public class Equals extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1904492608;

    /**
     * The parameter <code>equals.RETURN_VALUE</code>.
     */
     ...
     */
    public Equals() {
        super("equals", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
