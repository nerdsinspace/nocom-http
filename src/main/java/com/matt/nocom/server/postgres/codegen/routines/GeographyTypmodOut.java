...
public class GeographyTypmodOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1970404369;
    ...
    /**
     * The parameter <code>geography_typmod_out._1</code>.
     */
     ...
     */
    public GeographyTypmodOut() {
        super("geography_typmod_out", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));
