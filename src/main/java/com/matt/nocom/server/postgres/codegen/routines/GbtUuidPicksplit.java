...
public class GbtUuidPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1248271287;
     ...
     */
    public GbtUuidPicksplit() {
        super("gbt_uuid_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
