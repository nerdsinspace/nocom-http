...
public class GbtInt4Compress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1247671836;
     ...
     */
    public GbtInt4Compress() {
        super("gbt_int4_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
