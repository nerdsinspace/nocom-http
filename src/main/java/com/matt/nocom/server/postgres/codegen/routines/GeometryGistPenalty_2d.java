...
public class GeometryGistPenalty_2d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 376531595;
    ...
    public GeometryGistPenalty_2d() {
        super("geometry_gist_penalty_2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
