...
public class StX extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -386693699;

    /**
     * The parameter <code>st_x.RETURN_VALUE</code>.
     */
     ...
     */
    public StX() {
        super("st_x", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
