...
public class GinComparePrefixInt2 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1214218248;

    /**
     * The parameter <code>gin_compare_prefix_int2.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixInt2() {
        super("gin_compare_prefix_int2", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
