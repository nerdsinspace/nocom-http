...
public class _StLinecrossingdirection extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = -1810891629;

    /**
     * The parameter <code>_st_linecrossingdirection.RETURN_VALUE</code>.
     */
    ...
    public _StLinecrossingdirection() {
        super("_st_linecrossingdirection", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
