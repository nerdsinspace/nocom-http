...
public class GeometryContains extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1398454169;

    /**
     * The parameter <code>geometry_contains.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryContains() {
        super("geometry_contains", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
