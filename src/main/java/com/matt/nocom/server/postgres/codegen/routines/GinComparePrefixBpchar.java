...
public class GinComparePrefixBpchar extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1892696925;

    /**
     * The parameter <code>gin_compare_prefix_bpchar.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixBpchar() {
        super("gin_compare_prefix_bpchar", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
