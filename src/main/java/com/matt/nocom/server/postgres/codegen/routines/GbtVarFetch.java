...
public class GbtVarFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1038609930;
     ...
     */
    public GbtVarFetch() {
        super("gbt_var_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
