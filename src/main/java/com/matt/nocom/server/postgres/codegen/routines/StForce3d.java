...
public class StForce3d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1258207790;
     ...
     */
    public StForce3d() {
        super("st_force3d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
