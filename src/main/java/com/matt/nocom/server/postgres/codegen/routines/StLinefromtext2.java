...
public class StLinefromtext2 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 861089554;
     ...
     */
    public StLinefromtext2() {
        super("st_linefromtext", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
