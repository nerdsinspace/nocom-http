...
public class GbtTimePicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2106320613;
     ...
     */
    public GbtTimePicksplit() {
        super("gbt_time_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
