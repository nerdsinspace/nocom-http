...
public class GinComparePrefixFloat4 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1890397285;

    /**
     * The parameter <code>gin_compare_prefix_float4.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixFloat4() {
        super("gin_compare_prefix_float4", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
