...
public class PgisAsmvtFinalfn extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -1897826284;

    /**
     * The parameter <code>pgis_asmvt_finalfn.RETURN_VALUE</code>.
     */
     ...
     */
    public PgisAsmvtFinalfn() {
        super("pgis_asmvt_finalfn", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BLOB);
