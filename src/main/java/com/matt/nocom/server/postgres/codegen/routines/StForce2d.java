...
public class StForce2d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 409559436;
     ...
     */
    public StForce2d() {
        super("st_force2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
