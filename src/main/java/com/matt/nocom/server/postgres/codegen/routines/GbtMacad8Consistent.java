...
public class GbtMacad8Consistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1559654753;

    /**
     * The parameter <code>gbt_macad8_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtMacad8Consistent() {
        super("gbt_macad8_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
