...
public class StIsvalid1 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1172748150;

    /**
     * The parameter <code>st_isvalid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>st_isvalid._2</code>.
     */
     ...
     */
    public StIsvalid1() {
        super("st_isvalid", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
