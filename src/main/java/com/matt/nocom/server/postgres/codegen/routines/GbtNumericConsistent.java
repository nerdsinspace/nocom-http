...
public class GbtNumericConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1575870992;

    /**
     * The parameter <code>gbt_numeric_consistent.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtNumericConsistent() {
        super("gbt_numeric_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
