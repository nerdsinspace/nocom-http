...
public class GeometryAbove extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2045394248;

    /**
     * The parameter <code>geometry_above.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryAbove() {
        super("geometry_above", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
