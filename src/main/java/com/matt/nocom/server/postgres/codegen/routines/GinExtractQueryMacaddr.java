...
public class GinExtractQueryMacaddr extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -897388596;
    ...
    /**
     * The parameter <code>gin_extract_query_macaddr._3</code>.
     */
     ...
     */
    public GinExtractQueryMacaddr() {
        super("gin_extract_query_macaddr", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
