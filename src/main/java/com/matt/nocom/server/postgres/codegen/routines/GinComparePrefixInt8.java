...
public class GinComparePrefixInt8 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 806913560;

    /**
     * The parameter <code>gin_compare_prefix_int8.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixInt8() {
        super("gin_compare_prefix_int8", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
