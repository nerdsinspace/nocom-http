...
public class GinComparePrefixMacaddr8 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1507795574;

    /**
     * The parameter <code>gin_compare_prefix_macaddr8.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_macaddr8._3</code>.
     */
     ...
     */
    public GinComparePrefixMacaddr8() {
        super("gin_compare_prefix_macaddr8", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
