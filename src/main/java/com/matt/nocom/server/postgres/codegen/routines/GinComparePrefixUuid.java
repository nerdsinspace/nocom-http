...
public class GinComparePrefixUuid extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1668687189;

    /**
     * The parameter <code>gin_compare_prefix_uuid.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_uuid._1</code>.
     */
    public static final Parameter<UUID> _1 = Internal.createParameter("_1", org.jooq.impl.SQLDataType.UUID, false, true);

    /**
     * The parameter <code>gin_compare_prefix_uuid._2</code>.
     */
    public static final Parameter<UUID> _2 = Internal.createParameter("_2", org.jooq.impl.SQLDataType.UUID, false, true);

    /**
     * The parameter <code>gin_compare_prefix_uuid._3</code>.
     */
     ...
     */
    public GinComparePrefixUuid() {
        super("gin_compare_prefix_uuid", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
