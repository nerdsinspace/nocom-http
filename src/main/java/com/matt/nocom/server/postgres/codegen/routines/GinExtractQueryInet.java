...
public class GinExtractQueryInet extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 62449192;
    ...
    /**
     * The parameter <code>gin_extract_query_inet._3</code>.
     */
     ...
     */
    public GinExtractQueryInet() {
        super("gin_extract_query_inet", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
