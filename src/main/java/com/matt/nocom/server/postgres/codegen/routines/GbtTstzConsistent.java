...
public class GbtTstzConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -273524531;

    /**
     * The parameter <code>gbt_tstz_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gbt_tstz_consistent._2</code>.
     */
     ...
     */
    public GbtTstzConsistent() {
        super("gbt_tstz_consistent", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
