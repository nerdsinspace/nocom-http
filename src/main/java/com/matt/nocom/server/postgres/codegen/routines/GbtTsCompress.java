...
public class GbtTsCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1924860523;
     ...
     */
    public GbtTsCompress() {
        super("gbt_ts_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
