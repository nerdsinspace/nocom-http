...
public class GeometrySpgistLeafConsistent_3d extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1143742134;

    /**
     * The parameter <code>geometry_spgist_leaf_consistent_3d.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometrySpgistLeafConsistent_3d() {
        super("geometry_spgist_leaf_consistent_3d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
