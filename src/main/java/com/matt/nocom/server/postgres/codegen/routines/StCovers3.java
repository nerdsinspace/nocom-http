...
public class StCovers3 extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 1861910272;

    /**
     * The parameter <code>st_covers.RETURN_VALUE</code>.
     */
     ...
     */
    public StCovers3() {
        super("st_covers", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
