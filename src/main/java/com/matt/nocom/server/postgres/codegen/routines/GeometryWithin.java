...
public class GeometryWithin extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1940497492;

    /**
     * The parameter <code>geometry_within.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryWithin() {
        super("geometry_within", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
