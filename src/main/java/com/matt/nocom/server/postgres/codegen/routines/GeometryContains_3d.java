...
public class GeometryContains_3d extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1159481923;

    /**
     * The parameter <code>geometry_contains_3d.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryContains_3d() {
        super("geometry_contains_3d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
