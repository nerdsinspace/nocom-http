...
public class GeometrySpgistLeafConsistent_2d extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1176234485;

    /**
     * The parameter <code>geometry_spgist_leaf_consistent_2d.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometrySpgistLeafConsistent_2d() {
        super("geometry_spgist_leaf_consistent_2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
