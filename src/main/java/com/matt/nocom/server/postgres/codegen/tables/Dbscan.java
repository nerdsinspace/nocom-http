...
public class Dbscan extends TableImpl<DbscanRecord> {
    ...
    private static final long serialVersionUID = -852543160;
    ...
    public com.matt.nocom.server.postgres.codegen.tables.Dbscan dbscan() {
        return new com.matt.nocom.server.postgres.codegen.tables.Dbscan(this, Keys.DBSCAN__DBSCAN_CLUSTER_PARENT_FKEY1);
    }
