...
public class GeometrySpgistCompress_2d extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1511448107;
     ...
     */
    public GeometrySpgistCompress_2d() {
        super("geometry_spgist_compress_2d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
