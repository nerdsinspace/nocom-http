...
public class StSimplifypreservetopology extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -393246811;
    ...
    /**
     * The parameter <code>st_simplifypreservetopology._2</code>.
     */
    ...
    public StSimplifypreservetopology() {
        super("st_simplifypreservetopology", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
