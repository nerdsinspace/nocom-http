...
public class GbtOidDistance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 806629965;

    /**
     * The parameter <code>gbt_oid_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtOidDistance() {
        super("gbt_oid_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
