...
public class StNpoints extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = 2132685829;

    /**
     * The parameter <code>st_npoints.RETURN_VALUE</code>.
     */
     ...
     */
    public StNpoints() {
        super("st_npoints", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
