...
public class GeographyGistDecompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1646864747;
     ...
     */
    public GeographyGistDecompress() {
        super("geography_gist_decompress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
