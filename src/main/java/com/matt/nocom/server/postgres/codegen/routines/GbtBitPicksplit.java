...
public class GbtBitPicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 2042119709;
     ...
     */
    public GbtBitPicksplit() {
        super("gbt_bit_picksplit", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
