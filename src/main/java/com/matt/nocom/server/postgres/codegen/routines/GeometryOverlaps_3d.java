...
public class GeometryOverlaps_3d extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1471151729;

    /**
     * The parameter <code>geometry_overlaps_3d.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryOverlaps_3d() {
        super("geometry_overlaps_3d", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
