...
public class GinComparePrefixText extends AbstractRoutine<Integer> {
    ...
    private static final long serialVersionUID = -316099628;

    /**
     * The parameter <code>gin_compare_prefix_text.RETURN_VALUE</code>.
     */
    ...
    public GinComparePrefixText() {
        super("gin_compare_prefix_text", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
