...
public class GinComparePrefixInt4 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1236644834;

    /**
     * The parameter <code>gin_compare_prefix_int4.RETURN_VALUE</code>.
     */
     ...
     */
    public GinComparePrefixInt4() {
        super("gin_compare_prefix_int4", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
