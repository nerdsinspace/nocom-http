...
public class GbtTimeCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1834361796;
     ...
     */
    public GbtTimeCompress() {
        super("gbt_time_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
