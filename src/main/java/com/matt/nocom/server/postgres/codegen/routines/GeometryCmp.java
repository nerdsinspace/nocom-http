...
public class GeometryCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1584588728;

    /**
     * The parameter <code>geometry_cmp.RETURN_VALUE</code>.
     */
     ...
     */
    public GeometryCmp() {
        super("geometry_cmp", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
