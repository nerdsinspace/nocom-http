...
public class StM extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1186112327;

    /**
     * The parameter <code>st_m.RETURN_VALUE</code>.
     */
     ...
     */
    public StM() {
        super("st_m", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
