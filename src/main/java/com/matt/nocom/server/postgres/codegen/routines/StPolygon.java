...
public class StPolygon extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1709685976;
    ...
    /**
     * The parameter <code>st_polygon._2</code>.
     */
     ...
     */
    public StPolygon() {
        super("st_polygon", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
