...
public class Int4Dist extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -2141967076;

    /**
     * The parameter <code>int4_dist.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4Dist() {
        super("int4_dist", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
