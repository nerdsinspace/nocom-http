...
public class StNumpatches extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1633755689;

    /**
     * The parameter <code>st_numpatches.RETURN_VALUE</code>.
     */
     ...
     */
    public StNumpatches() {
        super("st_numpatches", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
