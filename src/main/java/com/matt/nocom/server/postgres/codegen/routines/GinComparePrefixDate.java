...
public class GinComparePrefixDate extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 996747565;

    /**
     * The parameter <code>gin_compare_prefix_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_date._1</code>.
     */
    public static final Parameter<LocalDate> _1 = Internal.createParameter("_1", org.jooq.impl.SQLDataType.LOCALDATE, false, true);

    /**
     * The parameter <code>gin_compare_prefix_date._2</code>.
     */
    public static final Parameter<LocalDate> _2 = Internal.createParameter("_2", org.jooq.impl.SQLDataType.LOCALDATE, false, true);

    /**
     * The parameter <code>gin_compare_prefix_date._3</code>.
     */
     ...
     */
    public GinComparePrefixDate() {
        super("gin_compare_prefix_date", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
