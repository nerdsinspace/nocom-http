...
public class GbtEnumFetch extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1445739075;
     ...
     */
    public GbtEnumFetch() {
        super("gbt_enum_fetch", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
