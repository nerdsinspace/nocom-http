...
public class StIsempty extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1742329216;

    /**
     * The parameter <code>st_isempty.RETURN_VALUE</code>.
     */
     ...
     */
    public StIsempty() {
        super("st_isempty", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.BOOLEAN);
