...
public class GbtMacadCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1523332500;
     ...
     */
    public GbtMacadCompress() {
        super("gbt_macad_compress", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
