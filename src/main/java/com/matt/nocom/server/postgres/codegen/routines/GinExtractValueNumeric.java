...
public class GinExtractValueNumeric extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -849643450;
    ...
    /**
     * The parameter <code>gin_extract_value_numeric._1</code>.
     */
     ...
     */
    public GinExtractValueNumeric() {
        super("gin_extract_value_numeric", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
