...
public class Keys {
    ...
    public static final ForeignKey<GeneratorCacheRecord, DimensionsRecord> GENERATOR_CACHE__GENERATOR_CACHE_DIMENSION_FKEY = ForeignKeys0.GENERATOR_CACHE__GENERATOR_CACHE_DIMENSION_FKEY;
    public static final ForeignKey<GeneratorCacheRecord, ServersRecord> GENERATOR_CACHE__GENERATOR_CACHE_SERVER_ID_FKEY = ForeignKeys0.GENERATOR_CACHE__GENERATOR_CACHE_SERVER_ID_FKEY;
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<GeneratorCacheRecord, DimensionsRecord> GENERATOR_CACHE__GENERATOR_CACHE_DIMENSION_FKEY = Internal.createForeignKey(Keys.DIMENSIONS_PKEY, GeneratorCache.GENERATOR_CACHE, "generator_cache_dimension_fkey", new TableField[] { GeneratorCache.GENERATOR_CACHE.DIMENSION }, true);
        public static final ForeignKey<GeneratorCacheRecord, ServersRecord> GENERATOR_CACHE__GENERATOR_CACHE_SERVER_ID_FKEY = Internal.createForeignKey(Keys.SERVERS_PKEY, GeneratorCache.GENERATOR_CACHE, "generator_cache_server_id_fkey", new TableField[] { GeneratorCache.GENERATOR_CACHE.SERVER_ID }, true);
