...
public class GinComparePrefixAnyenum extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 946645885;

    /**
     * The parameter <code>gin_compare_prefix_anyenum.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>gin_compare_prefix_anyenum._3</code>.
     */
     ...
     */
    public GinComparePrefixAnyenum() {
        super("gin_compare_prefix_anyenum", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.INTEGER);
