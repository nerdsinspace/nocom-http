...
public class GbtFloat4Distance extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1853734481;

    /**
     * The parameter <code>gbt_float4_distance.RETURN_VALUE</code>.
     */
     ...
     */
    public GbtFloat4Distance() {
        super("gbt_float4_distance", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.DOUBLE);
